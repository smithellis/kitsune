...
class DocumentForm(forms.ModelForm):
    ...
    restrict_to_staff = forms.BooleanField(
        ...
        required=False,
        help_text=_lazy(
            "The document will be restricted to staff members (and also group members if a group is selected)."
        ),
    )
    ...
    restrict_to_group = forms.ModelChoiceField(
        ...
        help_text=_lazy(
            "The document will be restricted to members of this group (and also staff if that is selected)."
        ),
    )
