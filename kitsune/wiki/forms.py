...
from kitsune.sumo.form_fields import MultiUsernameField, MultiUsernameOrDisplayNameField
...
class RevisionFilterForm(forms.Form):
    ...
    users = MultiUsernameOrDisplayNameField(label=_lazy("Users:"), required=False)
