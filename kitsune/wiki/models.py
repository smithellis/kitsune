...
class Document(NotificationsMixin, ModelBase, BigVocabTaggableMixin, DocumentPermissionMixin):
    ...
    def is_visible_for(self, user):
        ...
        """
        return self.is_unrestricted_for(user) and (
    ...
    def is_restricted(self):
        ...
        return self.restrict_to_staff or self.restrict_to_group
    ...
    def is_unrestricted_for(self, user):
        ...
        return (
            ...
            or (self.restrict_to_staff and (user.is_superuser or user.is_staff))
